...
$usuarioLogado = false; // Padrão: usuário não logado
...
if (isset($_SESSION['user_id'])) {
    ...
    // Se o usuário não existir no banco, trata como não logado
    if (!$user) {
        $usuarioLogado = false;
    }
}
...
<head>
<title>Perfil de <?= htmlspecialchars($user['username']) ?> - Hotel PHP</title>
  <meta charset="utf-8">
          ...
          <div class="header-bottom offcanvas offcanvas-end " id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              ...
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                ...
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="#about">Sobre</a>
                </li>
                <li class="nav-item px-3">
                  <a class="nav-link p-0" href="#services">Serviços</a>
                </li>
               <!-- Botão Cadastrar -->
               <?php if (!$usuarioLogado): ?>
                    <li class="nav-item px-3">
                        <a class="nav-link p-0" href="registro.php">Cadastrar</a>
                    </li>
                    <li class="nav-item px-3">
                        <a class="nav-link p-0" href="login.php">Entrar</a>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($usuarioLogado): ?>
                    <form action="index.php" method="POST">
                      <button type="submit" name="logout" class="nav-link p-0">Sair</button>
                    </form>
                <?php endif; ?>
      ...
      <div class="d-flex rounded-5"
        ...
        <div class="row align-items-center m-auto pt-5 px-4 px-lg-0">
          <div class="text-start col-md-6 col-lg-5 col-xl-6 offset-lg-1">
            <h2 class="display-1 fw-normal">Seja muito bem vindo, <?= htmlspecialchars($user['username']) ?>!</h2>
            <a href="#quartos" class="btn btn-arrow btn-primary mt-3">
              <span>Explore Quartos <svg width="18" height="18">
                  <use xlink:href="#arrow-right"></use>
                </svg></span>
            </a>
          </div>
          <div class="col-md-6 col-lg-5 col-xl-4 mt-5 mt-md-0">
    <form id="form" class="form-group flex-wrap bg-white p-5 rounded-4 ms-md-5" method="POST" action="datas.php">
        <h3 class="display-5">Cheque a Disponibilidade</h3>

        <!-- Check-In -->
        <div class="col-lg-12 my-4">
            <label for="checkin" class="form-label text-uppercase">Check-In</label>
            <div class="position-relative bg-transparent">
                <input type="date" id="checkin" name="checkin" class="form-control text-black-50 ps-3" required>
            </div>
        </div>

        <!-- Check-Out -->
        <div class="col-lg-12 my-4">
            <label for="checkout" class="form-label text-uppercase">Check-Out</label>
            <div class="position-relative bg-transparent" id="select-departure-date">
                <input type="date" id="checkout" name="checkout" class="form-control text-black-50 ps-3" required>
            </div>
        </div>

        <!-- Quartos -->
        <div class="col-lg-12 my-4">
            <label for="rooms" class="form-label text-uppercase">Quartos</label>
            <input type="number" id="rooms" name="rooms" class="form-control text-black-50 ps-3" value="1" min="1" required>
        </div>

        <!-- Convidados -->
        <div class="col-lg-12 my-4">
            <label for="guests" class="form-label text-uppercase">Convidados</label>
            <input type="number" id="guests" name="guests" class="form-control text-black-50 ps-3" value="1" min="1" required>
        </div>

        <!-- Botão -->
        <div class="d-grid">
            <button type="submit" class="btn btn-arrow btn-primary mt-3">
                <span id="feedbackMessage">Cheque a Disponibilidade
...
document.getElementById('form').addEventListener('submit', async function(event) {
  ...
  <section id="about-us" class="padding-large">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <h3 class="display-3 text-center fw-normal col-lg-4 offset-lg-4" id="about">Mellow: Your Gateway to Serenity</h3>
      <div class="row align-items-start mt-3 mt-lg-5">
        <div class="col-lg-6">
          <div class="p-5">
            ...
            <a href="#about" class="btn btn-arrow btn-primary mt-3">
              <span>Leia sobre nós <svg width="18" height="18">
                  <use xlink:href="#arrow-right"></use>
                </svg></span>
            </a>
          </div>
    ...
    <div class="container" data-aos="fade-up">
      <div class="row">
        <div class="col-md-3 text-center mb-4 mb-lg-0">
          ...
          <p class="text-capitalize">Clientes Satisfeitos</p>
        </div>
        <div class="col-md-3 text-center mb-4 mb-lg-0">
          ...
          <p class="text-capitalize">Totais de Quartos Quartos</p>
        </div>
        <div class="col-md-3 text-center mb-4 mb-lg-0">
          <h3 class="display-1 fw-normal text-primary position-relative">25 <span
              class="position-absolute top-100 pb-5 translate-middle z-n1"><img src="images/pattern1.png" alt="pattern"
                class="img-fluid"></span></h3>
          <p class="text-capitalize">Prêmios Ganhos</p>
        </div>
        <div class="col-md-3 text-center mb-4 mb-lg-0">
          <h3 class="display-1 fw-normal text-primary position-relative">200 <span
              class="position-absolute top-50 end-50 pb-lg-4 pe-lg-2 translate-middle z-n1"><img
                src="images/pattern1.png" alt="pattern" class="img-fluid"></span></h3>
          <p class="text-capitalize">Membros Totais</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="room" class="padding-medium">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div>
          <h3 class="display-3 fw-normal text-center" id="quartos">Explore nossos Quartos</h3>
        </div>
        <a href="#quartos" class="btn btn-arrow btn-primary mt-3">
          <span>Explore Quartos<svg width="18" height="18">
              <use xlink:href="#arrow-right"></use>
          ...
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Quartos de Luxo</h4>
                ...
                <table>
                  <tbody>
                    <tr class="text-white">
                      <td class="pe-2">Preço:</td>
                      <td class="price">299$ /Por noite</td>
                    </tr>
                    <tr class="text-white">
                      <td class="pe-2">Tamanho:</td>
                      <td>10 ft</td>
                    </tr>
                    <tr class="text-white">
                      <td class="pe-2">Capacidade:</td>
                      <td>Max pessoas 2</td>
                    </tr>
                    <tr class="text-white">
                    ...
                    <tr class="text-white">
                      <td class="pe-2">Serviços:</td>
                      <td>Wifi, Televisão, Banheiro,...</td>
                    </tr>
                  </tbody>
                </table>
                <a href="#">
                  <p class="text-decoration-underline text-white m-0 mt-2">Pesquise Agora</p>
                </a>
              </div>
            </div>
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="#">Quartos de Luxo</a></h4>
              <p><span class="text-primary fs-4">$269</span>/noite</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Quarto Tamanho Família</h4>
                <p class="product-paragraph text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Molestiae at illum ipsum similique doloribus.</p>
                <table>
                  <tbody>
                ...
                <a href="#">
                  <p class="text-decoration-underline text-white m-0 mt-2">Explore Agora</p>
                </a>
              </div>
            </div>
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="#">Quarto Tamanho Família</a></h4>
              <p><span class="text-primary fs-4">$360</span>/noite</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Quarto de Casal</h4>
                <p class="product-paragraph text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  Molestiae at illum ipsum similique doloribus.</p>
                <table>
                  <tbody>
                    <tr class="text-white">
                      <td class="pe-2">Preço:</td>
                      <td class="price">299$ /Pernoite</td>
                    </tr>
                    <tr class="text-white">
                      <td class="pe-2">Tamanho:</td>
                      <td>10 ft</td>
            ...
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="#">Quarto de Casal</a></h4>
              <p><span class="text-primary fs-4">$450</span>/noite</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
  ...
  <section id="gallery" data-aos="fade-up">
    <h3 class="display-3 fw-normal text-center">Nossa Galeria</h3>
  ...
  <section id="services" class="padding-medium">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <h3 class="display-3 text-center fw-normal col-lg-4 offset-lg-4" id="services">Nossos Serviços & Facilidades</h3>
      <div class="row mt-5">
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            ...
            <h4 class="display-6 fw-normal my-3">Yoga & Meditação</h4>
            ...
            <a href="#" class="btn btn-arrow">
              <span class="text-decoration-underline">Leia Mais<svg width="18" height="18">
                  <use xlink:href="#arrow-right"></use>
                </svg></span>
            </a>
          </div>
        ...
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            ...
            <h4 class="display-6 fw-normal my-3">Jantar</h4>
            <p>Rejuvenate your body and mind with our yoga and meditation classes, led by experienced instructors.
              Whether you're a beginner or an advanced practitioner, our classes cater to all levels and offer a
              peaceful retreat from the hustle and bustle of the city. With serene surroundings and expert guidance.</p>
            <a href="#" class="btn btn-arrow">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            ...
            <h4 class="display-6 fw-normal my-3"> Centro Fitness</h4>
            <p>Rejuvenate your body and mind with our yoga and meditation classes, led by experienced instructors.
              Whether you're a beginner or an advanced practitioner, our classes cater to all levels and offer a
              peaceful retreat from the hustle and bustle of the city. With serene surroundings and expert guidance.</p>
            <a href="#" class="btn btn-arrow">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            ...
            <h4 class="display-6 fw-normal my-3">Espaços de Eventos</h4>
            <p>Rejuvenate your body and mind with our yoga and meditation classes, led by experienced instructors.
              Whether you're a beginner or an advanced practitioner, our classes cater to all levels and offer a
              peaceful retreat from the hustle and bustle of the city. With serene surroundings and expert guidance.</p>
            <a href="#" class="btn btn-arrow">
        ...
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            ...
            <h4 class="display-6 fw-normal my-3"> Wi-Fi Grátis</h4>
            <p>Rejuvenate your body and mind with our yoga and meditation classes, led by experienced instructors.
              Whether you're a beginner or an advanced practitioner, our classes cater to all levels and offer a
              peaceful retreat from the hustle and bustle of the city. With serene surroundings and expert guidance.</p>
            <a href="#" class="btn btn-arrow">
  ...
  <section id="blog" class="padding-medium pt-0">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <div class="d-flex flex-wrap align-items-center justify-content-between">
        <div>
          <h3 class="display-3 fw-normal text-center">Nossos Blogs e Eventos</h3>
        </div>
      ...
      <div class="row mt-5">
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            ...
            <div class="position-absolute bottom-0 p-5">
              <a href="#"><span class="bg-secondary text-body m-0 px-2 py-1 rounded-2 fs-6">Hotéis</span></a>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            ...
            <div class="position-absolute bottom-0 p-5">
              <a href="#"><span class="bg-secondary text-body m-0 px-2 py-1 rounded-2 fs-6">Atividades</span></a>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            ...
            <div class="position-absolute bottom-0 p-5">
              <a href="#"><span class="bg-secondary text-body m-0 px-2 py-1 rounded-2 fs-6">Quartos</span></a>
    ...
    <div class="container-fluid padding-side padding-small pt-0" data-aos="fade-up">
      <footer class="row">
        ...
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
          <h4 class="display-6 fw-normal">Entre em nosso Newsletter</h4>
...
document.getElementById('newsletterForm').addEventListener('submit', async function(event) {
    ...
    try {
        ...
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
          <h4 class="display-6 fw-normal">Nossas Informações</h4>
      ...
      <footer class="row">
        <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item"><a href="#" class="p-0 "> Sobre nós </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Nossos Serviços </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Privacy Policy</a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Contato </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Suporte </a></li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
          <h4 class="display-6 fw-normal">Serviços</h4>
          <ul class="nav flex-column">
            <li class="nav-item"><a href="#" class="p-0 "> Spa </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Piscina </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Yoga </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Academia</a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Notícias </a></li>
            <li class="nav-item"><a href="#" class="p-0 "> Termos & Condições </a></li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
